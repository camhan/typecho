...
<div id="container">
	...
	<div id="column"> 	 	 	   
		...
		<div id="header" class="border">
			...
			<div class="mast">
				<div id="title">
					<h1><a href="http://yydd.be/">Deef's Life</a></h1>
					<h3>Life is brief, and then you die, you know?</h3>
				</div>
				<div id="nav">
					...
					<ul>
						<li class="profile"><a href="http://yydd.be/about.html"><span class="tip"><span class="bubble">About</span></span></a></li>
						<li class="twitter"><a href="http://twitter.com/DeefMr"><span class="tip"><span class="bubble">Twitter</span></span></a></li>
						<!--li class="random"><a href="/random"><span class="tip"><span class="bubble">Random</span></span></a></li-->
						<li class="ask"><a href="http://yydd.be/guestbook.html"><span class="tip"><span class="bubble">AskMe</span></span></a></li>
